    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">Ratings/Feedback</a>
                </li>
                <li class="nav-item">
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <div class="row">
                ...
                require 'config.php';
                $ayd = $_SESSION['ayd'];
                $sql = "SELECT *,rentals.status AS st FROM rentals JOIN equipments on rentals.equipId = equipments.equipId WHERE rentals.userId = '$ayd'";
                $r = $con->query($sql);
