    ...
    <body class="">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-header-primary">
                                        <h4 class="card-title ">Pending Rental Requests</h4>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <table class="table" id="example" width="100%">
                                                ...
                                                <tbody>
                                                    <%
                                                        ...
                                                        ResultSet rs = st.executeQuery("SELECT * FROM `rentals` JOIN users on rentals.userId = users.userid JOIN equipments ON rentals.equipId = equipments.equipId WHERE rentals.status = 'Pending' AND equipments.spid = '" + ayd + "'");
                                                        if (!rs.next()) {
                                            ...
                                            <table class="table" id="example" width="100%">
                                                ...
                                                <tbody>
                                                    <%
                                                        ...
                                                        rs = st.executeQuery("SELECT * FROM `rentals` JOIN users on rentals.userId = users.userid JOIN equipments ON rentals.equipId = equipments.equipId WHERE rentals.status = 'Renting' AND equipments.spid = '" + ayd + "'");
                                                        if (!rs.next()) {
                                                            out.print("<tr><td>No records</td></tr>");
                                                        } else {
                                                            rs.beforeFirst();
                                                            while (rs.next()) {
                                                                ...
                                                                out.println("</td><td>" + "<a href='jsp/done.jsp?rid=" + rs.getInt("rentalid") + "&eid=" + rs.getInt("equipments.equipId") + "' class='btn btn-success'><i class='material-icons'>done</i></a>");
                                                                out.println("</td></tr>");
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <form action="jsp/addEquipment.jsp" method="post">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input required type="email" name="cemail" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input required type="text" name="cadd" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="bmd-label-floating">Company Number</label>
                                                                <input required type="number" name="cnum" min="10"
                                                                       class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="bmd-label-floating">Equipment Name</label>
                                                                <input required type="text"  name="equipname"
                                                                       class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea required type="text"  name="equipdesc" 
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input required type="text"  name="enginenum"
                                                                       class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="exampleFormControlFile1" class="btn btn-success"> Upload Image</label>
                                                                <input type="file" name="eimage" class="form-control-file" id="exampleFormControlFile1">
                                                            </div>
                                                        </div>
                                                    </div>
