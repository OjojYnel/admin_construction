                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form name="frm" action="jsp/up.jsp" enctype="multipart/form-data" method="post">
                                                    <input class="form-control" type="file" name="uProperty" /> <br>
                                                    <input type="submit" class="btn btn-success" name="goUpload" value="Upload" />
                                                </form>
