            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                                               ...
                                               Integer ayd =(Integer) session.getAttribute("ayd");
                                                ...
                                                if(!rs.next()){
                                                    ...
                                                    while(rs.next()){
                                                        ...
                                                        out.println("</td><td>" +  "<a href='jsp/disable.jsp?rid=" + rs.getInt("equipId") + "' class='btn btn-success'><i class='material-icons'>close</i></a>");
                                                        out.println("</td></tr>");
                        ...
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title ">Disabled Equipments</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table" id="example" width="100%">
