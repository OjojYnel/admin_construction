                                            ...
                                            <table class="table" id="example" width="100%">
                                                ...
                                                <tbody>
                                                    <%
                                                        ...
                                                        ResultSet rs = st.executeQuery("SELECT * FROM `rentals` JOIN users on rentals.userId = users.userid JOIN equipments ON rentals.equipId = equipments.equipId WHERE rentals.status !='Renting' AND  equipments.spid = '" + ayd + "'");
                                                        if (!rs.next()) {
